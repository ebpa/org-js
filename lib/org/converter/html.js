...
ConverterHTML.prototype = {
  ...
  makeSubscript: function (match, body, subscript) {
    return this.tag("span", body, {class: "org-subscript-parent"}) +
        this.tag("span", subscript, {class: "org-subscript-child"});
  },
    ...
    for (var attributeName in attributesObject) {
      if (attributesObject.hasOwnProperty(attributeName)) {
        ...
        if (attributeName === "class") {
          attributeValue = attributeValue.split(' ').map(this.orgClassName, this).join(' ');
